...
function setup()
{
  legendas.rows.sort((a, b) => a.get('city name').localeCompare(b.get('city name')));
  legendas.rows.forEach((row, index) => {
    row.set("ID", index + 1); // Substitui o ID pela nova ordem (1, 2, 3...)
  });
